...
public class ArmaduraService {
    ...
    public void correr(Armadura arm) {
        ...
        System.out.println("Ingrese cuanto tiempo va a correr");
        tiempo = sc.nextInt();
    ...
    public void propulsar(Armadura arm) {
        ...
        System.out.println("Ingrese cuanto tiempo va a propulsar");
        tiempo = sc.nextInt();

        arm.setBateria(arm.getBateria() - (arm.getBotas().getEnergia() * 3 * tiempo));

        System.out.println("La energia gastada al propulsarse es: " + (arm.getBotas().getEnergia() * 3 * tiempo));

    }
    
//     public void volar(Armadura arm) {
//         
//         System.out.println("Ingrese cuanto tiempo va a volar");
//        tiempo = sc.nextInt();
//        
//         arm.setBateria(arm.getBateria() - (((arm.getBotas().getEnergia() *3) + (arm.getGuantes().getEnergia()*2)) * tiempo));  
//
//        System.out.println("La energia gastada al volar es: " + (((arm.getBotas().getEnergia() *3) + (arm.getGuantes().getEnergia()*2)) * tiempo));
//         
//     }
